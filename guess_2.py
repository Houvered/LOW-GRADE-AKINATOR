...
csv_path = r"E:\JULY\Akinator\guess_dataset.csv"
df = pd.read_csv(csv_path)

def guess_object(df, csv_path):
    print("Think of an object (person, animal, thing). I will try to guess it.")
    ...
    user_answers = {}  # Store user's answers for learning
    ...
    for trait in traits:
        ...
        if answer == "yes":
            ...
            pass  # No filtering for Maybe etc.
...
# Run the game and update df accordingly
df = guess_object(df, csv_path)
